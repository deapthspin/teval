...
const FormQuestions = (props) => {
  ...
  const handleServiceSubmit = () => {
    ...
    if(!invalid) {
      ...
      console.log(formId, formId + 1, formId + 2, formId + 3)
      for(let i= 0; i < serviceListValues.length; i++) {
        
        fetch(`https://formcreationapppostgresql.herokuapp.com/forms/${formId - 1}/questions`, {
          method: "POST",
          body: JSON.stringify({
            questionId: i,
        ...
        fetch(`https://formcreationapppostgresql.herokuapp.com/forms/${formId}/questions`, {
          method: "POST",
          body: JSON.stringify({
            questionId: i,
            question: serviceListValues[i]
        ...
        fetch(`https://formcreationapppostgresql.herokuapp.com/forms/${formId + 2}/questions`, {
          method: "POST",
          body: JSON.stringify({
            questionId: i,
            question: serviceListValues[i]
