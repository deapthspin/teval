    ...
    async function submit() {
        ...
        let data = await res.json()
            ...
            let data2 = await response.json()
                ...
                let res4 = await fetch(`https://formcreationapppostgresql.herokuapp.com/responses/${currentFormId + 2}`)
                ...
                let res5 = await fetch(`https://formcreationapppostgresql.herokuapp.com/responses/${currentFormId + 3}`)
                ...
                setTimeout(() => setCanRender(true), 80)
    }
